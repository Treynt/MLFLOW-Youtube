...
if __name__ == "__main__":
    ...
    with mlflow.start_run(run_name="model_registry") as run:
        ...
        mlflow.sklearn.log_model(artifact_path="rft_model2", sk_model=RandomForestRegressor()) #Não vai entrar no models registry automaticamente pq não foi setado um nome de modelo para registro, mas pode ser feito pelo mlfow ui
